...
from data_utils.utils import preprocess_data_set, \
    get_prelim_encoder, get_npz_translation_data, get_sanity_check_data
...
def main():
    ...
    raw_train_data = get_sanity_check_data()
    ...
    # transformer = train(transformer, train_data, None)
    # save_model(transformer)
    translate(transformer, None, prelim_encoder)
